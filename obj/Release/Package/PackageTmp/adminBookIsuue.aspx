<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="adminBookIsuue.aspx.cs" Inherits="WestlakeInternatinalProject.adminBookIsuue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
 <img width="150px" src="img/logo/issuelogo2.png" />
 </center>
                            </div>
                        </div>
                        <div class="row">
                ...
                <a href="adminLibrary.aspx"><< Back to Library Management 
                </a>
                <br>
                <br>
            </div>
 ...
 <h4>Issued Book List</h4>
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:westlake_schoolDBConnectionString %>' SelectCommand="SELECT * FROM [book_issue_table]"></asp:SqlDataSource>
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="user_id" OnRowDataBound="GridView1_RowDataBound">
                                    <Columns>
                                        <asp:BoundField DataField="user_id" HeaderText="User ID" SortExpression="user_id" ReadOnly="True"></asp:BoundField>
